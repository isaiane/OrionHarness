...
- **Observabilidade de custo/tokens por execução (T4.3/O4):** convenção base do sinal de **custo/
  ...
  **checklist mínimo por funcionalidade**. Exemplo mínimo rodável
  ...
  usuário** → e2e formal dispensada, ADR-0009). Ledger projeta a #53 (5 critérios, `passes:false`; dois
  critérios multi-linha aparecem truncados — bug conhecido do gerador, **#45**). **Fecha o épico O4.**
  (#53)
