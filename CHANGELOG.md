...
- **Campo de rastro de promoção no template SDD (#151, follow-up do #150 ⑤):** o template
  ...
  **"Promovida de (Milestone/épico)"** (não-obrigatório), que solicita o rastro
  ...
  em que um contribuidor preenchia todos os campos e criava uma Issue sem o rastro G1→Issue. Fast-lane /
  Issue não promovida seguem válidas com o campo vazio.
