...
| **L1** Plano | **GitHub Milestones (épicos) + Issues + Project** (fonte); relatório gerado (`.orion/tmp/reports/plan.md`); [`PLAN.md`](PLAN.md)/[`docs/plans/`](docs/plans/) = stub-ponteiro | Mapa de épicos e detalhamento |
