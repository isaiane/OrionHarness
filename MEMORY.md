...
| **L1** Plano | GitHub **Milestones** (épico; descrição = objetivo + tarefas) + **Issues** (fonte) · [`PLAN.md`](PLAN.md)/[`docs/plans/`](docs/plans/) = stub-ponteiro | Mapa de épicos (no GitHub) e detalhamento |
