...
| # | Épico | Objetivo | Status | Issues |
|---|-------|----------|--------|--------|
| O1 | Coerência dos guardrails | CI bloqueante (T1.1) + enforcement do G3 por perfil (T1.2) + reconciliar §7 à postura lean/flat (T1.3) | em andamento | #15 (T1.1, concluída) · #18 (T1.2, concluída) · #23 (T1.3, em review) |
...
| T1.3 | Reconciliar `AGENTS.md §7` à postura lean/flat: Clean Arch/Hexagonal e event-driven → opt-in (default = encapsulamento simples); regra das 3 responsabilidades + guardrail dos 3–4 arquivos; via ADR-0004 | T2 | G2 (ADR) | em review | #23 |
