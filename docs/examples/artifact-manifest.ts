...
export const MANIFEST: ManifestEntry[] = [
  ...
  { file: "docs/architecture/foundations.md", rule: "fast-lane", role: "pointer", destiny: "keep", slice: null, group: "na",
    note: "T9.5b (#137): a menção do modelo de confiança (cerimônia proporcional) virou PONTEIRO (§11.2/ADR-0017). A cadeia de auditoria issue-less (branch→commit→PR→merge, PR=unidade) no §1.5 PERMANECE como contrato de rastreabilidade próprio da seção — já aponta p/ §11.2 (D2 'executa'/contrato)." },
