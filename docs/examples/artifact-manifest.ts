...
export const MANIFEST: ManifestEntry[] = [
  // ─── plano-L1 — PLAN.md/docs/plans como mapa de épicos / fonte de plano (ADR-0025 item 1) ───────────
  {
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Estubado na T9.3b: vira stub-ponteiro p/ Milestones/Project + relatório gerado; enquanto o §4 o nomear como stub, permanece (remoção = fatia futura própria).",
  },
  {
    file: "docs/plans/",
    rule: "plano-L1",
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Diretório de detalhamento (L1; só .gitkeep). Resolvido na T9.3b: .gitkeep→README stub-ponteiro p/ Milestones/PLAN.md.",
  },
  {
    file: "AGENTS.md",
    rule: "plano-L1",
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "§4 tabela L1 + fase Plan/Spec (§2) + bala Status reescritos p/ Milestones+Issues+Project na T9.3b (redação do ADR-0025). Roteamento status/história permanece p/ T9.4b.",
  },
  {
    file: "MEMORY.md",
    rule: "plano-L1",
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Índice L1 repontado p/ Milestones/Project na T9.3b (PLAN.md/docs/plans citados como stub).",
  },
  {
    file: "README.md",
    rule: "plano-L1",
    ...
    note: "Diagrama do ciclo e árvore de arquivos citam PLAN.md como mapa de épicos. Menção de nav (não-contraditória) — repoint deferido ao follow-up #143 (fora do núcleo atômico T9.3b, §7).",
  },
  {
    file: "docs/README.md",
    rule: "plano-L1",
    ...
    group: "plan-history",
    normativeSourceRef: true,
    note: "Link de navegação 'mapa de épicos' → PLAN.md. Nav — repoint deferido ao follow-up #143 (fora do núcleo atômico T9.3b, §7).",
  },
  {
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Setup checklist (adoção) + get-bearings (passo 3) + ciclo Plan repontados p/ Milestones/Project + relatório gerado na T9.3b.",
  },
  {
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Fluxo Plan repontado: 'o trabalho entra no board do Project (Milestone + draft items)' na T9.3b.",
  },
  {
    ...
    group: "plan-history",
    normativeSourceRef: true,
    note: "Harness Review trata PLAN.md/docs/plans como estado substantivo. Heurística de review (não read-path do plano) — repoint deferido ao follow-up #143 (fora do núcleo atômico T9.3b, §7).",
  },
  {
    ...
    group: "plan-history",
    normativeSourceRef: true,
    note: "Runbook: 'Milestones representam os épicos do PLAN.md' — descrição operacional (não read-path); repoint deferido ao follow-up #143 (Milestone = fonte; §7).",
  },
  {
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Footer link p/ PLAN.md como mapa de épicos. Nav — repoint deferido ao follow-up #143 (fora do núcleo atômico T9.3b, §7).",
  },
  {
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Instrução ativa pós-G0 repontada p/ Milestones/Project na T9.3b (era 'registre os épicos em PLAN.md' — contradição direta com o stub, por isso entrou no núcleo atômico).",
  },
  {
    file: "STATE.md",
    rule: "plano-L1",
    ...
    slice: "T9.3b",
    group: "plan-history",
    note: "Footer 'Ponteiros' repontado (PLAN.md = stub → Milestones/Project) no pré-flip desta fatia. O cabeçalho 'status→refletido no PLAN.md' é roteamento (T9.4b), não tocado aqui.",
  },
  {
