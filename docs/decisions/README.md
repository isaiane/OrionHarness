...
| [ADR-0029](0029-install-da-skill-e-reimport-app-managed.md) | Install da skill é reimport app-managed (supersede as cláusulas de install do ADR-0028) | proposto |
