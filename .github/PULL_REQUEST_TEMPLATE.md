...
- [ ] Estado **roteado por camada** (ADR-0024) quando aplicável: história→`CHANGELOG.md`; status→Issue SDD (projeção→ledger/`PLAN.md`); `STATE.md` **só o ponteiro** (`Agora`/`Próximo passo`/`última conclusão` + riscos/nav), **sem** narrativa nem status por-item
